                    ...
                    >
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                          ...
                          {["personal_productivity_hub", "recurring_tasks", "structured_project_updates", "decision_register", "ai_assistance"].includes(entitlement.key) ? (
                      ...
                      <div className="flex items-center gap-2">
                        {([
                          ...
                          >
                            {["personal_productivity_hub", "recurring_tasks", "structured_project_updates", "decision_register", "ai_assistance"].includes(entitlement.key) && override === true
                              ? "Enable pilot"
                              : label}
                          </Button>
                        ))}
